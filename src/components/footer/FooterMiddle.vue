      ...
      <div class="row">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 col_4202 col-style">
          <div class="infos-footer box-footer">
            <div class="module">
              <h3 class="modtitle">{{t("Footer.Middle.ContactInfo")}}</h3>
              <ul>
                <li class="adres">
                  <i class="fa fa-map-marker">1</i>Address : 123 Suspendis
                  mattis, Sollicit District, <br />NY Accums Fringilla
                </li>
                <li class="mail">
                  <i class="fa fa-envelope">2</i>Email : support@domain.com
                </li>
                <li class="phone">
                  <i class="fa fa-mobile">3</i>Hotline 1 : 0123-456-78910
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 col_bko7 col-style">
          <div class="box-account box-footer">
            <div class="module clearfix">
              <h3 class="modtitle">{{t("Footer.Middle.MyAccount")}}</h3>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 col_6urb col-style">
          <div class="box-information box-footer">
            <div class="module clearfix">
              <h3 class="modtitle">{{t("Footer.Middle.Information")}}</h3>
              <div class="modcontent">
                <ul class="menu">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 col_3d8g col-style">
          <div class="box-service box-footer">
            <div class="module clearfix">
              <h3 class="modtitle">{{t("Footer.Middle.Services")}}</h3>
              <div class="modcontent">
                <ul class="menu">
      ...
      <div class="row middle2">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-style">
          <div class="app-store module">
            <h3 class="modtitle">{{t("Footer.Middle.DownloadAPP")}}:</h3>
            <ul>
              <li>
                <a title="App Store" href="#">
                  <img
                    src="../../assets/image/catalog/demo/payment/app-1.png"
                    alt="App Store"
                  />
                </a>
              </li>
              <li>
                <a title="App Store" href="#">
                  <img
                    src="../../assets/image/catalog/demo/payment/app-2.png"
                    alt="App Store"
                  />
                </a>
              </li>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
          <div class="socials-w module">
            <h3 class="modtitle">{{t("Footer.Middle.FollowUs")}}:</h3>
            <ul class="socials">
              <li class="facebook">
                <a
                  class="_blank"
